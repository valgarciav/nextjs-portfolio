...
const EmailSection = () => {
    ...
    emailjs.sendForm("service_3jq9jha", "template_xx9dzd5", form.current,'qr-bha9pEfH-lwXuV')
      .then((result) => {
          console.log(result.text);
          console.log("message sent");
          alert("SUCCESS! YOUR EMAIL IS NOW IN VALERIA INBOX");
      }, (error) => {
        ...
        <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary-900 to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -translate-x-1/2 -translate-1/2">
          ...
          try my best to get back to you!
            ...
            <div className='socials flex flex-row gap-2'>
                <Link href="https://github.com/valgarciav">
                    <Image 
                    src={GithubIcon} 
                    alt="Github Icon" 
                    /> 
                </Link>
                <Link href="https://www.linkedin.com/in/valeria-garciav/">
                    <Image 
                    src={LinkedinIcon} 
                    alt="Linkedin Icon" 
                    /> 
