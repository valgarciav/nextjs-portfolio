  ...
  return (
    ...
    />
        ...
        <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-yellow-300 via-purple-500 to-blue-400 hover:bg-slate-200 text-white"
            >
              Hire Me
            </Link>
            <Link
